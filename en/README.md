...
1. Download `BDSpyrunner.dll`, `mc.py` and `BDSpyrunner.pdb` from [Release](https://github.com/WillowSauceR/BDSpyrunner/releases/latest). pdb files are not required, but are useful for feedback in case of crashes.
